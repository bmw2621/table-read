...
**Test Isolation**: When tests pass individually but fail when run together, use **spies** (`jest.spyOn()`) instead of **mocks** (`jest.mock()`) for service dependencies. Always restore spies in `afterAll()` hooks. See `.specify/memory/testing-best-practices.md` for detailed guidance.
...
**Version**: 1.0.1 | **Ratified**: 2025-12-09 | **Last Amended**: 2025-12-12
