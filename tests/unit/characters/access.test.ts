...
import { canAccessCharacter } from "@/lib/characters/access";
...
describe("Character Access Control", () => {
  ...
  describe("canAccessCharacter", () => {
    it("should return true when character exists and user has access to script", async () => {
      const result = await canAccessCharacter(mockCharacterId, mockUserId);
